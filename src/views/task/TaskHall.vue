...
<style scoped>
.food-delivery-active { display: grid; gap: 10px; }.food-delivery-active h3 { margin: 0; color: var(--color-text-secondary); font-size: 13px; }.food-delivery-card.active { border-color: var(--color-primary); background: var(--color-primary-soft); }
.food-delivery-board { display: grid; gap: 14px; border: 1px solid var(--color-border); border-radius: var(--radius-card); padding: 20px; background: var(--color-surface); }.food-delivery-board__head { display: flex; align-items: end; justify-content: space-between; gap: 16px; border-bottom: 1px solid var(--color-border); padding-bottom: 12px; }.food-delivery-board__head h2 { margin: 0 0 3px; color: var(--color-navy); font-size: 18px; }.food-delivery-board__head p { margin: 0; color: var(--color-text-muted); font-size: 13px; }.food-delivery-list { display: grid; gap: 10px; }.food-delivery-card { display: flex; align-items: center; justify-content: space-between; gap: 20px; border: 1px solid var(--color-border); border-radius: 8px; padding: 14px 16px; background: var(--color-fill); }.food-delivery-card__main { display: grid; min-width: 0; gap: 3px; }.food-delivery-card__type { color: var(--color-primary); font-size: 11px; font-weight: 800; letter-spacing: .04em; }.food-delivery-card__main strong { color: var(--color-navy); }.food-delivery-card__main p { overflow: hidden; margin: 0; color: var(--color-text-secondary); text-overflow: ellipsis; white-space: nowrap; font-size: 13px; }.food-delivery-card__route { display: flex; flex-wrap: wrap; gap: 5px 14px; color: var(--color-text-muted); font-size: 12px; }.food-delivery-card__route span + span::before { margin-right: 14px; color: var(--color-border-strong); content: '→'; }.food-delivery-card__action { display: grid; min-width: 100px; justify-items: end; gap: 2px; }.food-delivery-card__action b { color: var(--color-primary); font-size: 19px; }.food-delivery-card__action small { color: var(--color-text-muted); font-size: 11px; }.food-delivery-card__action .btn { margin-top: 5px; white-space: nowrap; }.food-delivery-board__empty, .food-delivery-board__error { border-radius: 8px; padding: 13px 14px; background: var(--color-fill); color: var(--color-text-muted); font-size: 13px; }.food-delivery-board__error { display: flex; align-items: center; justify-content: space-between; gap: 12px; color: var(--color-danger); }
...
.filter-chip:hover { border-color: var(--color-primary); color: var(--color-primary); }.filter-chip.active { border-color: var(--color-primary); background: var(--color-primary); color: #fff; }
.relay-task-card { position: relative; overflow: visible; border-color: var(--color-border) !important; transition: transform var(--transition-fast), border-color var(--transition-fast); }.relay-task-card:hover { transform: translateY(-1px); border-color: var(--color-primary) !important; }
...
.route-dot { width: 10px; height: 10px; border: 2px solid var(--color-surface); border-radius: 50%; box-shadow: 0 0 0 1px currentColor; }.route-dot.pickup { color: #7da6ff; background: #7da6ff; }.route-dot.delivery { color: var(--color-primary); background: var(--color-primary); }
