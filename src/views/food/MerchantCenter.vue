...
type Merchant = { id: number; name: string; description?: string | null; announcement?: string | null; min_order_amount?: number; prepare_minutes?: number; address: string; phone?: string | null; status: string; audit_note?: string | null; is_open: boolean; commission_rate: number }
