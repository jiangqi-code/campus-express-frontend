...
.top { display: flex; align-items: center; justify-content: space-between; gap: 24px; margin-bottom: 18px; border-radius: var(--radius-card); padding: 28px 30px; background: var(--color-navy); }.top h1 { margin: 0; color: #fff; font-size: clamp(25px, 2.4vw, 36px); letter-spacing: -.035em; }.top p { margin: 6px 0 0; color: rgba(220,230,249,.68); }
.actions { display: flex; align-items: center; gap: 14px; color: rgba(220,230,249,.72); font-size: 12px; }.system-state { display: inline-flex; align-items: center; gap: 7px; color: #b9ceff; }.system-state::before { width: 7px; height: 7px; border-radius: 50%; background: #6d9cff; content: ""; }.actions button { border: 1px solid rgba(184,205,246,.42); border-radius: var(--radius-button); padding: 9px 14px; background: transparent; color: #fff; font-weight: 700; cursor: pointer; }.actions button:hover { border-color: #fff; background: #fff; color: var(--color-navy); }
